...
//        jadwal = hillClimbingTabuHardConstrain(jadwal, hariRange, guruPJOK);
        ...
        System.out.println("Pelanggaran MGMP total: " + hitungTotalPenaltiMGMP(jadwal, hariRange, MGMPsenin, MGMPselasa, MGMPrabu, MGMPkamis));
        ...
        System.out.println("Pelanggaran total: " + hitungTotalSemuaPenalti(jadwal,
                hariRange,
                guruPJOK,
                MGMPsenin,
                MGMPselasa,
    ...
    static Object[] generateGuruPreview(String guruNum, String[][] jadwal, int[][] hariRange,
        ...
        for (int h = 0; h < hariRange.length; h++) {
            ...
            for (int b = 0; b < barisPer; b++) {
                ...
                if (LBL_KHUSUS[b] != null) {
                    kelas = sholatLabel(LBL_KHUSUS[b], h);
                } else {
                    int slot = start + jamKe - 1;
                    for (int k = 0; k < allKelas.length; k++) {
                        if (slot < jadwal.length && k < jadwal[slot].length) {
    ...
    static Object[] generateKelasPreview(int kelasIdx, String[][] jadwal, int[][] hariRange,
        ...
        for (int h = 0; h < hariRange.length; h++) {
            ...
            for (int b = 0; b < barisPer; b++) {
                ...
                if (LBL_KHUSUS[b] != null) {
                    mapel    = sholatLabel(LBL_KHUSUS[b], h);
                } else {
                    int slot = start + jamKe - 1;
...
// =======================================================================
    ...
    private static String sholatLabel(String label, int dayIdx) {
        return "Sholat Zuhur".equals(label) && dayIdx == 4 ? "Sholat Jumat" : label;
    }
